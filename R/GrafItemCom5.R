# dirgrf = dirgrafico
# nomgrf = 'Comuns_EnccPT12_Encc19MT'
# grupos = c('EN19', 'PT12')
# 
# itcom = itcomEncc19MT_EF_PPLv1$PT12
# colsitcom = c('coditem','nomeblg','itemblg','gab','EN19','PT12')
# 
# gabpar1 = gabparEncc19MT_EF_PPLv1
# colsgabpar1 = c('coditem','nomeblg','it','bl','ob','aorig','borig','c')
# percpr1 = percprEncc19MT_EF_PPLv1
# rj1 = expEncc19MT_EF_PPLv1
# 
# 
# gabpar2 = blm_EnccEN19_MT_EF_PPL_v1$grupos$PT12
# colsgabpar2 = c('nomeblg','seq')
# rj2 = blm_EnccEN19_MT_EF_PPL_v1$expected$PT12
# percpr2 = blm_EnccEN19_MT_EF_PPL_v1$percpr$PT12
# 
# proj = 'ENCCEJA 2019 - BR PPL'
# anodisc = 'Ensino Fundamental - Matemática - PT12 x EN19'
# modo = 'normal'
# rect = TRUE


GrafItemCom5 <- function(dirgrf, nomgrf, grupos, itcom, colsitcom,
                         ...
                         proj, anodisc, modo = 'normal', rect = TRUE)
{
  ...
  for(item in 1:nitemcomum)
  {
    ...
    curve(CesgTools::plogis3(x, para*D, parb, parc), add = TRUE)
    ...
    analiseDif[[2]][[item]] <- rbind(gabpar1[nmblg,c('codigo', taux)], cbind(codigo = gabpar1[nmblg, 'codigo'], gabpar2[nmblg,taux]))
    ...
    ### separa proporcoes
    props <- rbind(CesgTools::plogis3(unlist(analiseDif[[1]]), para*D, parb, parc),
                   rj1[nmblg,compara],
                   rj2[nmblg,compara])
...
#Store(GrafItemCom5, lib = Bni19Bolsa, lib.loc = dirBNI19Bolsa_R)
